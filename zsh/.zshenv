...
export FZF_DEFAULT_OPTS="--multi --cycle --keep-right --height=40% --layout=reverse --border=rounded --info=inline --ansi --preview='[[ -f {} ]] && [[ \$(file --brief --dereference --mime-type {}) =~ text ]] && bat --color=always --style=numbers --line-range=:200 {}'"
